...
export class FileListLoader {
     ...
     * @param {boolean} dontCacheIt If we don't want to keep a cache copy of the content
     * @returns {any}
     */
    public getFileContent (fileId: string, dontCacheIt: boolean = false): any {
        return this.collection.getContentOf(fileId, dontCacheIt);
    }
